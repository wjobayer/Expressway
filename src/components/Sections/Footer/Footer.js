...
import exp from '../../../images/expressway1.png';
...
const Footer = () => {
    return (
        <div className="footer">
            ...
            <div>
            <div className="m-3 d-block flex-column text-center">
                <img src={exp} width="150px" alt=""className="my-3" />
                <img src={gplay} width="150px" alt="" />
            </div>
            <div className="mt-3">
